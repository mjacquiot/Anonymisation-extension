...
(function() {
  ...
  const COMMON_PRENOMS_MASCULINS = new Set([
    "aaron", "adam", "adrien", "ahmed", "alain", "albert", "alessio", "alexandre", "alexis", "ali", "amand", "andre",
  ...
  const COMMON_PRENOMS_FEMININS = new Set([
    "adele", "adeline", "agathe", "alice", "amanda", "amelie", "amina", "anais", "anne", "anne-sophie", "annie", "apolline",
  ...
  const FRENCH_STOP_WORDS = new Set([
    "-amenagement", "-brac", "aad-nvpdl", "abbassia", "absents", "abu", "accessibilite", "accession", "accessoires", "accompagnement", "accoord", "accroissement",
    ...
    "agents", "agglomeration", "agile", "agir", "agla", "agnes", "agora", "agricole", "agriculture", "aicha", "aide", "aides",
    ...
    "aws", "axe", "axes", "ayant", "aymeric", "azerbaidjan", "aziliz", "azure", "azzi", "backend", "bail", "bainvel",
    ...
    "blin", "bogota", "bois", "boismenu", "boisrame", "boissiere", "bolo", "bon", "bonamy", "bonjour", "boreal", "boris",
    ...
    "campagnes", "candidat", "candidats", "car", "caractere", "carole", "carquefou", "casque", "cassette", "castets", "categorie", "categories",
    ...
    "eleves", "elhadi", "eli", "elle", "elles", "elon", "elu", "elus", "email", "emails", "emile", "emmanuel",
    ...
    "eram", "erevan", "erp", "erreur", "erreurs", "erwan", "esblg", "escapade", "espace", "espaces", "estime", "et",
    ...
    "experimentation", "expression", "fabien", "fabrice", "fabrik", "factory", "factotum", "facture", "factures", "faculte", "faisons", "familial",
    "familiale", "famille", "familles", "faq", "faso", "faux", "faveur", "fayat", "fcm", "fdaec", "federation", "federations",
    "felix", "fellonneau", "ferre", "festival", "fete", "fetes", "fibre", "fichier", "fichiers", "figuls", "fikry", "fil",
    ...
    "georges", "gerald", "gerontopole", "gessant", "gestion", "ggr", "ghislaine", "gilbert", "gildas", "gironde", "gironde ressources", "git",
    ...
    "harcelement", "harmonie", "haroun", "haute", "haute-garonne", "hautes", "hauts-paves", "hdd", "hdmi", "herve", "heure", "heures",
    "hip", "hirondelle", "histoire", "historique", "hlm", "homme", "horaires", "hormis", "hors", "hotel annexe gardette", "hotel gardette", "houda",
    "html", "http", "https", "hubert", "huchet", "hulya", "hybrides", "ia", "iae", "ici", "ide", "idea",
    ...
    "javascript", "javo", "je", "jet", "jeune", "jeunes", "jeunesse", "jeux", "jira", "joel", "johanna", "johnny",
    "jose", "josephine", "jouin", "jour", "journee", "jours", "jusqu'au", "jusque", "kabbaj", "kari", "kejadenn", "kerbrat",
    ...
    "legrand", "lemaire", "leon", "lequel", "leroux", "lerude", "les", "lesquelles", "lesquels", "let's", "leur", "leurs",
    ...
    "mangin", "manifestation", "manufacture", "map", "marais", "marche", "marches", "marinette", "maritime", "maritimes", "marlene", "martin",
    ...
    "multi", "municipal", "municipalite", "municipaux", "musee", "musee de l'imprimerie", "nadege", "naguere", "nangeville", "nantais", "naoned", "national",
    ...
    "parti", "partout", "pas", "pascouau", "passage", "patis", "patrice", "patrimoine", "patrimoniale", "pauvres", "pav", "pays",
    ...
    "romy", "ronan", "rosnet", "route", "rse", "rte", "rue", "rufisque", "rullo", "rurale", "sa", "saadi",
    ...
    "sujets", "super", "superieur", "superieure", "supervision", "sur", "surete", "surface", "sylvain", "syndical", "synthese", "systeme",
  ...
  function pseudonymizeText(text, sessionState, config = {}) {
    ...
    while ((match = wordRegex.exec(text)) !== null) {
      ...
      let isKnownPrenom = COMMON_PRENOMS.has(normalizedWord);
      if (!isKnownPrenom && normalizedWord.includes('-')) {
        const parts = normalizedWord.split('-');
        isKnownPrenom = parts.every(p => COMMON_PRENOMS.has(p) || COMMON_NOMS.has(p));
      }
